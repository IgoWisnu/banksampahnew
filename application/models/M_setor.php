...
class M_setor extends CI_Model {
    ...
    /**
     * Insert header transaksi_sampah. Tetap sama seperti sebelumnya.
     */
    ...
    public function insertDtSampah($id){
        ...
        foreach ($list_id_jenis as $key => $value){
            // Snapshot harga sekarang utk audit (jaga2 kalau admin
            // ubah harga setelah ini, kita tetap punya catatan).
     ...
     * Tetap dipertahankan untuk backward-compatibility — tapi sekarang
     * fungsinya sebagai cache, sumber kebenaran ada di v_saldo_dinamis_nasabah.
     */
