<body>
    ...
    <div id="nasabah-table-container" class="containered pt-3">
        <div class="row mx-2">
            ...
            <div class="modal fade" id="tambahNasabahModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="<?= base_url('dashboard/tambahnasabah') ?>" method="post"
            ...
            <div class="modal fade" id="importNasabahModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <form action="<?= base_url('dashboard/importnasabah') ?>" method="post"
                                enctype="multipart/form-data">
                                <div class="mb-3">
                                    <label for="username" class="form-label">Username</label>
                                    <input type="file" class="form-control" id="excel_nasabah" name="excel_nasabah">
                                </div>
                                <button type="submit" class="btn btn-primary">Tambah</button>
                            </form>
                        </div>
            ...
            <div class="row align-items-start">
                ...
                <div class="col-lg-6">
                    <form action="<?= base_url() ?>dashboard/loadNasabah" method="post">
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" placeholder="Enter username/email" id="keyword"
                                name="keyword">
                ...
                <?= isset($_SESSION['keyword_nasabah']) ? $_SESSION['keyword_nasabah'] : '' ?>
                <div class="col-lg-4">
                    <button type="button" class="btn btn-success mb-3 ms-0" data-bs-toggle="modal"
                        data-bs-target="#tambahNasabahModal">
                        Tambah Nasabah
                    </button>
                    <a href="<?= base_url() ?>uploads/excel/template_banksampah.xlsx" class="btn btn-primary mb-3 ms-0">
                        Download Excel
                    </a>
                    <button type="button" class="btn btn-warning mb-3 ms-0" data-bs-toggle="modal"
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#exampleModal" data-profile="<?php echo $key['profile'] ?>"
                                        ...
                                        data-alamat="<?php echo $key['alamat'] ?>" data-email="<?php echo $key['email'] ?>"
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img id="modal-profile-img" src="" alt="Profile Image"
