                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p class="mb-0 fs-6 text-white-50" style="max-width: 800px;">
                                Selamat datang di ruang kerja Admin Banjar. Di sini Anda bisa melayani penyetoran sampah dari nasabah, melakukan penarikan saldo, serta memantau pergerakan harga sampah hari ini.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="card border-0 shadow-sm rounded-3 h-100">
                ...
                <div class="card-body p-4">
                    <div class="d-grid gap-3">
                        <a href="<?= base_url('dashboard/loadNasabah') ?>" class="btn btn-outline-success p-3 text-start rounded-3 fw-medium" style="transition: 0.3s;">
                        ...
                        <a href="<?= base_url('dashboard/loadNasabah') ?>" class="btn btn-outline-danger p-3 text-start rounded-3 fw-medium" style="transition: 0.3s;">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
        ...
        <div class="col-lg-6">
             <div class="card border-0 shadow-sm rounded-3 h-100">
                ...
                <div class="card-body p-4">
                    ...
                    <a href="<?= base_url('dashboard/loadBerita') ?>" class="btn btn-light w-100 text-start p-3 rounded-3 text-dark shadow-sm">
