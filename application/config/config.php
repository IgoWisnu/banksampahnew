...
|
*/
$config['base_url'] = 'http://localhost/banksampah-2026/banksampahnew/';
...
$config['csrf_token_name'] = 'csrf_banksampah_token';
$config['csrf_cookie_name'] = 'csrf_banksampah_cookie';
